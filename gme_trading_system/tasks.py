...
daily_briefing_task = Task(
    description=(
        ...
        "CRITICAL RULE — Do not infer direction from sentiment or bias:\n"
        "  - Calculate: (current_price - opening_price) / opening_price * 100\n"
        "  - If result > 0.5%, direction = RISING\n"
        "  - If result < -0.5%, direction = FALLING\n"
        "  - Otherwise, direction = SIDEWAYS\n"
        "  - Use this calculated direction in the MARKET line. Do NOT override based on sentiment.\n\n"
